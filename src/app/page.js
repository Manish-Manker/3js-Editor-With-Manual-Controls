...
const ThreejsOLD = () => {
  ...
  const keyframes2 = [
    { positionX: 0, positionY: 1, positionZ: 0, rotationY: 0, rotationX: 0, rotationZ: 0, cameraZ: 5.5, duration: 1000 },
    { positionX: 0, positionY: -0.4, positionZ: 0, rotationY: Math.PI * 2, rotationX: 0, rotationZ: 0, cameraZ: 5.5, duration: 1000 },
    { positionX: 0, positionY: -0.4, positionZ: 0, rotationY: Math.PI * 2, rotationX: -0.6, rotationZ: 0, cameraZ: 3.5, duration: 1000 },
    { positionX: 0, positionY: -0.4, positionZ: 0, rotationY: Math.PI * 2, rotationX: 0, rotationZ: 0, cameraZ: 5.5, duration: 1000 },
  ];
  ...
  return (
    <>
      <div style={{ display: "flex", height: "100vh", width: `${isRecording ? "290vh" : "140vh"}`, padding: "10px", overflow: "hidden" }}>
